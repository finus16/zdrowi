	...
	public function render_content() {
		...
		switch( $this->type ) {
			...
			case 'id':
				...
				$html .= $this->create_input_group( $this->id, $field_name, 'text', $field_class, $this->placeholder, $this->value, $this->prefix, $this->suffix);
			break;
			...
			case 'repeatable_fieldset':
				ob_start();
				include ( justart_slider()->assets_dir .'/template-parts/'. $this->template );
				$html .= ob_get_clean();
			break;
		}
